...
class UrlsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create url" do
    assert_difference('Url.count') do
      post urls_url, params: { url: { slug: @url.slug, snapshot: @url.snapshot, visits: @url.visits } }
    end
  ...
  test "should update url" do
    patch url_url(@url), params: { url: { slug: @url.slug, snapshot: @url.snapshot, visits: @url.visits } }
